...
$_lang['prop_is.phpthumbofParams_desc'] = 'An optional string of parameters to pass to phpThumbOf.<br>Be careful with this one though, since phpThumbOf will be run on <b>every</b> image in the input, not just the oversized ones.<br>Certain parameters&mdash;w, h, f, q, zc&mdash;may be overridden by imageSlim depending on the image and other settings.';
